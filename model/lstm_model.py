...
class LSTMFeatureExtractor(nn.Module):
    def __init__(self, vocab_size, embedding_dim, output_size, n_classes=7, dropout=0.5):
        ...
        self.proj = nn.Linear(output_size * 2, n_classes)
    ...
    def forward(self, x, qmask, umask):
        ...
        for idx, b in enumerate(contexts):
            ...
            # encoder 相关
            # enc_output, enc_slf_attn = self.self_attn_enc(
            #     h,
            #     non_pad_mask=non_pad_mask,
            #     slf_attn_mask=slf_attn_mask)
            # print(h.shape, slf_attn_mask.shape)
            # onehead 相关
        ...
        out = self.proj(sent_h)  # batch,sent_num,class
        return out, [], [], []
